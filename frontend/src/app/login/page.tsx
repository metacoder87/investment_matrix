...
export default function LoginPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const sessionReady = await login(data.access_token, redirectTo);
            if (!sessionReady) {
                throw new Error("Sign in succeeded, but the browser session was not established. Please try again.");
            }
        } catch (err: any) {
